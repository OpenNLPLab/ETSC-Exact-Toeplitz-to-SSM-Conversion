...
class MemTracker(object):
    ...
    """
    def __init__(self, detail=True, path='mem_profile', name="", verbose=False, device=0):
        ...
        if name == "":
            ...
            self.gpu_profile_fn = path + f'/{name}-{datetime.datetime.now():%d-%b-%y-%H:%M:%S}-gpu_mem_track.txt'
